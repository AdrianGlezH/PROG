...
public class Metodos {
    ...
    public static void lonxTexto(){
        ...
        System.out.println("La longitud es de "+texto.length()+" caracteres.");
    }
    ...
    public static void contarVeC(){
        ...
        System.out.println("La frase contienen "+consonantes+" consonantes");
    }
    ...
    public static void contCaract(){
        String cadea = "Hola, soy alumno de DAM1, y soy programador desde el 2021";
        int letra = 0;
        int digitos = 0;
        int espacios = 0;
        ...
        System.out.println("Nº letras: " + letra + "\nNº de dígitos: " + digitos + "\nNº de espacios: " + espacios);
    }
